...
const CarouselProvider = class CarouselProvider extends React.Component {
  ...
  render() {
    const {
      ...
      interval: _interval,
      isPageScrollLocked: _isPageScrollLocked,
      isPlaying: _isPlaying,
      lockOnWindowScroll: _lockOnWindowScroll,
      naturalSlideHeight: _naturalSlideHeight,
      naturalSlideWidth: _naturalSlideWidth,
      ...
      infinite: _infinite,
      isIntrinsicHeight: _isIntrinsicHeight,
      ...filteredProps
    } = this.props;
